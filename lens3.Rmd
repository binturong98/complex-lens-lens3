...
### Normal light conditions
```{r normal light behaviour stats}
...
results_dark_horizontal <- behaviour_data %>%
  filter(light_environment == 'dark', arena == 'horizontal') %>%
  welch_anova_test(latency_min ~ probe)

results_dark_horizontal

results_dark_vertical <- behaviour_data %>%
  filter(light_environment == 'dark', arena == 'vertical') %>%
  welch_anova_test(latency_min ~ probe)

results_dark_vertical
