...
```{r relative edge sharpness regression plots}
...
```{r supplementary edge sharpness regressions}
...
# Print graph
cairo_pdf(file = "Figures/edge_regression_supplement.pdf", width = 12,  height = 8) # cairo_pdf is able to handle special characters
grid.arrange(arrangeGrob(edge_supplement_plot, left = y.grob,
                         bottom = x.grob))
dev.off()
```
