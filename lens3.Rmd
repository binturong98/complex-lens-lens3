...
```{r figure S1: edge sharpness curves}
...
```{r figure S2: maximum edge sharpness boxplots}
...
```{r figure S3: back focal length boxplots}
...
```{r figure S4: ophthalmoscope left right asymmetry}
